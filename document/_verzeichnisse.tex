...
Für ein Abkürzungsverzeichnis ist das folgende \texttt{package} notwendig: 
\lstinline$ \usepackage{acronym} $. Es wird in folgender Art und Weise erstellt:
...
\lstinputlisting[label=lst:verz:acro2]{./src/verz/acro2.tex}
